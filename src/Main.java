        ...
        if(kpmgenset.exists())
        {
            ...
            try(Scanner reader = new Scanner(kpmgenset))
            {
                while(reader.hasNext()) {
                    ...
                    System.out.println("Number of state " + states.size());
                    ...
                    System.out.println("Number of category " + categories.size());
                    ...
                    for (String state:states)
                    {
                        try(PrintWriter writter = new PrintWriter(new File(state+".txt")))
                        {
                            for(SolarData row:solarData)
                            {
